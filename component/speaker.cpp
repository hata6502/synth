...
#define OUT_THRU 0
vector<string> Speaker::getOut() { return vector<string>{"thru"}; }
...
var Input = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this.ui_class = UiInput; this._val = 0.0;
                //this._i = 0;
        }
...
var UiInput = class extends UiComponent{
        constructor(com, uisk){
                super(com, uisk);
                this._jqinput = $('<input style="width: 112px; text-align:
inherit; " placeholder="(ex.) 440.0">');
        }

        initDom(){
                super.initDom();
                var column = $('<td colspan="2" style="text-align: center;
"></td>'); column.append(this._jqinput);
...
var Keyboard = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this.ui_class = UiKeyboard;
        }
...
var Amplifier = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length);
        }

        onChangeIn(){
                super.onChangeIn();
                this.outs[this.Out.amp].latch =
this.ins[this.In.in_1].val*this.ins[this.In.in_2].val; return this.update();
        }
};
...
var Integrator = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this._int = 0.0;
        }
...
var Differentiator = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this._prev = 0.0;
        }
        ...
        onChangeTime(e){
                super.onChangeTime(e);
                this.outs[this.Out.diff].latch = (this.ins[this.In.in_].val -
this._prev)/e.dt; this._prev = this.ins[this.In.in_].val; return this.update();
        }
};
...
Object.keys(this.Out).length);
        ...
        onChangeTime(e){
                super.onChangeTime(e);
                this.outs[this.Out.square].latch =
(this.phase%(2.0*Math.PI)<2.0*Math.PI*this.ins[this.In.duty].val)?1.0:-1.0;
                this.phase += this.ins[this.In.freq].val*e.dt*2.0*Math.PI;
                return this.update();
        }
};
...
var Saw = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this.phase = 0.0;
        }

        onChangeTime(e){
                super.onChangeTime(e);
                this.outs[this.Out.saw].latch =
this.phase%(2.0*Math.PI)/(2.0*Math.PI)*2.0 - 1.0; this.phase +=
this.ins[this.In.freq].val*e.dt*2.0*Math.PI; return this.update();
        }
};
...
Object.keys(this.Out).length); this.phase = 0.0;
        ...
        onChangeTime(e){
                ...
                if (o_phase<Math.PI){
                        this.outs[this.Out.tri].latch = o_phase/Math.PI*2.0
- 1.0; }else{ this.outs[this.Out.tri].latch = (1.0 - (o_phase -
...
var Scope = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this.ui_class = UiScope;
                ...
                if (this._data_j%this._skip==0){
                        ...
                        if (this._data_i){
                                ...
                                switch(this.mode){
                                        ...
                                        go = this.prev<this.trig &&
this.trig<=this.ins[this.In.in_].val; break; case Scope.Mode.falling: go =
this.ins[this.In.in_].val<this.trig && this.trig<=this.prev; break;
                                }
                        }

                        if (go){
                                this.data[this._data_i++] =
this.ins[this.In.in_].val; this._data_i %= 256;
                        }
...
var ctx = this._canvas.getContext('2d');
    ...
    options: {
        ...
        scales: {
                ...
                this._jqskip = $('<input type="number" value="1" style="width:
48px; " min="1">');
        }
        ...
        initDom(){
                super.initDom();
                var column = $('<td colspan="2" style="text-align: center;
"></td>'); column.append(this._jqmodebtn); column.append(" Trigger ");
...
Object.keys(this.Out).length);
        ...
        onChangeIn(){
                super.onChangeIn();
                this.outs[this.Out.sat].latch =
Math.min(this.ins[this.In.in_1].val, this.ins[this.In.in_2].val); return
this.update();
        }
};
...
Object.keys(this.Out).length);
        ...
        onChangeIn(){
                super.onChangeIn();
                this.outs[this.Out.sat].latch =
Math.max(this.ins[this.In.in_1].val, this.ins[this.In.in_2].val); return
this.update();
        }
};
...
var Meter = class extends Component{
        ...
        constructor(){
                super();
                this.initPort(Object.keys(this.In).length,
Object.keys(this.Out).length); this.ui_class = UiMeter; this.val = 0.0;
        }
...
var UiMeter = class extends UiComponent{
        constructor(com, uisk){
                super(com, uisk);
                this._jqdisplay = $('<input style="width: 112px; text-align:
inherit; " disabled>');
        }
        ...
        initDom(){
                super.initDom();
                var column = $('<td colspan="2" style="text-align: center;
"></td>'); column.append(this._jqdisplay);
                this.jqobj.append($('<tr></tr>').append(column));
...
var Custom = class extends Component{
        ...
        set sketch(value){
                ...
                this.initPort(this._sk.int_ins.length,
this._sk.int_outs.length);
        ...
        onChangeIn(){
                ...
                if (this._sk){
                        ...
                        chcoms = chcoms.filter((chcom, i) => { return
i==chcoms.indexOf(chcom); });

                        while(chcoms.length){
                                chcoms = chcoms.filter((chcom, i) => { return
i==chcoms.indexOf(chcom); }); var com = chcoms.shift();
                                Array.prototype.push.apply(chcoms,
com.onChangeIn());
                        }
                }
                return this.update();
